...
class Input:
    ...
    def checkForKeyboardInput(self):
        ...
        if pressedKeys[K_LEFT] or pressedKeys[K_h] or pressedKeys[K_a] and not pressedKeys[K_RIGHT] and not pressedKeys[K_d]:
            self.entity.traits["goTrait"].direction = -1
        elif pressedKeys[K_RIGHT] or pressedKeys[K_l] or pressedKeys[K_d] and not pressedKeys[K_LEFT] and not pressedKeys[K_a]:
            self.entity.traits["goTrait"].direction = 1
        else:
            self.entity.traits['goTrait'].direction = 0

        isJumping = pressedKeys[K_SPACE] or pressedKeys[K_UP] or pressedKeys[K_k] or pressedKeys[K_w] or pressedKeys[K_SPACE]
